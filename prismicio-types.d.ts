...
export interface FormSliceDefaultPrimary {
  /**
   * Form ID field in *Form → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: form.default.primary.form_id
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ShowcaseSliceDefaultPrimary {
  /**
   * Header field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.default.primary.header
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface ShowcaseSliceReversePrimary {
  /**
   * Header field in *Showcase → Reverse → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.reverse.primary.header
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  header: prismic.RichTextField;
